...
var _default = api => {
  ...
  api.onGenerateFiles({
    fn() {
      var _api$config$dva3, _api$config, _api$config$dva4;
...
app.model({ namespace: '${(0, _path().basename)(path, (0, _path().extname)(path))}', ...Model${lodash.upperFirst(lodash.camelCase((0, _path().basename)(path, (0, _path().extname)(path))))}${index} });
      ...
      api.writeTmpFile({
        ...
        content: Mustache.render(connectTpl, {
          dvaHeadExport: ((_api$config$dva4 = api.config.dva) === null || _api$config$dva4 === void 0 ? void 0 : _api$config$dva4.disableModelsReExport) ? `` : models.map(path => {
            // prettier-ignore
  ...
  api.modifyBabelOpts(babelOpts => {
    var _api$config$dva5;

    const hmr = (_api$config$dva5 = api.config.dva) === null || _api$config$dva5 === void 0 ? void 0 : _api$config$dva5.hmr;
